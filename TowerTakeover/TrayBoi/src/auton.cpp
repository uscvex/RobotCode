...
//
//
//    TRAYPOS,CLAW_CLOSE_POS_A,           // GRAB CUBE                        FIRST CUBE
//    PAUSE,0.25,
//    LIFTPOS,LIFT_GRAB_POS,              // RAISE LIFT
...
double programmingSkills[] = {
    ...
    TRAYPOS,CLAW_OPEN_POS_A,            //                                    FIRST TOWER
    PAUSE,0.25,
    DRIVEDIST,-60,270,7,2,
    ...
    TRAYPOS,CLAW_CLOSE_POS_A,           // GRAB CUBE                        SECOND CUBE
    PAUSE,0.25,                         // PAUSE FOR GRAB
    TURN,225,1,                         // TURN FOR TOWER
    
    TRAYPOS,CLAW_OPEN_POS_A,            // OPEN CLAW
    DRIVEDIST,60,225,2,1,               // DRIVE FORWARD
    DRIVEDIST,70,225,10,2,              // DRIVE CLOSE TO TOWER
    TRAYPOS,CLAW_CLOSE_POS_A,           // GRAB
    ...
    TRAYPOS,CLAW_OPEN_POS_A,            // DROP CUBE                        SECOND TOWER
    ...
    TRAYPOS,CLAW_CLOSE_POS_A,           // GRAB CUBE                        THIRD CUBE
    ...
    TRAYPOS,CLAW_OPEN_POS_A,            // DROP CUBE                        THIRD TOWER
    ...
    TRAYPOS,CLAW_CLOSE_POS_A,           // GRAB CUBE                        FOURTH CUBE
    ...
    PAUSE,0.25,                         // PAUSE FOR STABLE
    TRAYPOS,CLAW_OPEN_POS_A,            // DROP CUBE                        FOURTH TOWER
...
double programmingSkills2[] = {
    ...
    DRIVEDIST,40,180,15,5,              // DRIVE TO TOWER
    //PAUSE,0.25,                         // PAUSE FOR STABLE
    TRAYPOS,CLAW_OPEN_POS_A,            // DROP CUBE                        FIRST TOWER
    PAUSE,0.5,                          // WAIT FOR CUBE TO FALL
    ...
    TRAYPOS,CLAW_CLOSE_POS_A,           // CLOSE CLAW
...
//    DRIVE,-100,270,0.5,                 // DRIVE INTO WALL
    ...
    PAUSE,0.25,                         // PAUSE FOR GRAB
    TRAYPOS,CLAW_CLOSE_POS_A,           // GRAB CUBE                        FIFTH CUBE
    PAUSE,0.25,                         // PAUSE FOR GRAB
    TURN,225,1,                         // TURN FOR TOWER
    ...
    TRAYPOS,CLAW_OPEN_POS_A,            // DROP CUBE                        FIFTH TOWER
    ...
    TRAYPOS,CLAW_OPEN_POS_A,            // DROP CUBE                        SIXTH TOWER
