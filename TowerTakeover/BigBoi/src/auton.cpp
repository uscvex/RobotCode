...
double redAuton[] = {                   // ONE STACK OF 13 CUBES
    ...
    DRIVETO,70,270,-34,-45,4,             // DRIVE BACK FROM ROW
    ...
    DRIVETO,70,0,-49,-27,3,              // DRIVE BACK FROM CUBE
    
    // BONUS CUBE
    DRIVETO,70,0,-57,-31,3,              // DRIVE TO LINE UP FOR NEXT CUBE
    DRIVETO,50,0,-57,-15,3,             // DRIVE TO GET CUBE                    SECOND.5 TOWER CUBE
    // END BONUS CUBE
    
    DRIVETO,80,0,-58,-25,3,              // SLIDE TO LINE UP FOR ROW OF 3

    
    DRIVETO,70,270,-59,-22,3,             // DRIVE AND TURN TO LINE UP FOR 3
    DRIVETO,40,270,-43,-22,3,             // DRIVE TO GET 2 OUT OF 3            ROW OF 3
    
    DRIVETO,70,270,-52,-22,3,             // DRIVE BACK FROM CUBE
    
    
    DRIVETO,90,270,-52,-45,3,              // SLIDE TO LINE UP FOR NEXT TWO
    DRIVETO,80,0,-22,-45,3,                 // DRIVE AND TURN FOR NEXT CUBES
    DRIVETO,50,0,-22,-10,3,                 // DRIVE TO GET NEXT CUBES          STACK OF 2
    PAUSE,0.5,
...
//    DRIVEDIST,40,315,135,0.5,0.5,            // DRIVE OUT A BIT CORNER
//    DRIVEDIST,40,135,135,0.01,0.5,            // DRIVE BREAK
...
double blueAuton[] = {                  // ONE STACK OF 13 CUBES
    ...
    DRIVETO,70,90,59,-22,3,             // DRIVE AND TURN TO LINE UP FOR 3
    DRIVETO,40,90,43,-22,3,             // DRIVE TO GET 2 OUT OF 3            ROW OF 3
    
    DRIVETO,70,90,52,-22,3,             // DRIVE BACK FROM CUBE
    
    
    DRIVETO,90,90,52,-45,3,              // SLIDE TO LINE UP FOR NEXT TWO
    DRIVETO,80,0,22,-45,3,                 // DRIVE AND TURN FOR NEXT CUBES
    DRIVETO,50,0,22,-10,3,                 // DRIVE TO GET NEXT CUBES          STACK OF 2
    PAUSE,0.5,
...
//    DRIVEDIST,40,45,225,0.5,0.5,            // DRIVE OUT A BIT CORNER
//    DRIVEDIST,40,225,225,0.01,0.5,            // DRIVE BREAK
