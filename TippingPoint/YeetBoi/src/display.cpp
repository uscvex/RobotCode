...
void run_display(void* params) {
    ...
    while (true) {
        ...
        string output = "";
        if (!is_red) output = "Not Sticker";
        else output = "Sticker";
        screen::print(TEXT_MEDIUM, 1, "State: %s", output);
        screen::print(TEXT_MEDIUM, 2, "hue: %f \n", hue);
        screen::print(TEXT_MEDIUM, 3, "brightness: %f \n", RGB_values.brightness);
        screen::print(TEXT_MEDIUM, 4, "Proximity: %d", proximity);
        screen::print(TEXT_MEDIUM, 5, "Red value: %f \n", RGB_values.red);
        screen::print(TEXT_MEDIUM, 6, "green value: %f \n", RGB_values.green);
        screen::print(TEXT_MEDIUM, 7, "blue value: %f \n", RGB_values.blue);
        screen::print(TEXT_MEDIUM, 8, "saturation: %f \n", saturation);
